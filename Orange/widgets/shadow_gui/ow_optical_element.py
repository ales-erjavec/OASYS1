    ...
    def __init__(self, graphical_options = GraphicalOptions()):
        ...
        if self.graphical_options.is_screen_slit:
            ...
            if self.graphical_options.is_mirror:
                ...
                ShadowGui.lineEdit(self.mosaic_box_2, self, "angle_spread_FWHM", "Angle spread FWHM [deg]", valueType=float, orientation="horizontal")
                ShadowGui.lineEdit(self.mosaic_box_2, self, "thickness", "Thickness [cm]", valueType=float, orientation="horizontal")
                ShadowGui.lineEdit(self.mosaic_box_2, self, "seed_for_mosaic", "Seed for mosaic [>10^5]", valueType=float, orientation="horizontal")
           ...
           ##########################################
            ...
            ShadowGui.lineEdit(self.sou_mov_box_1, self, "sm_offset_x_source_ref_frame", "offset X [cm] in SOURCE reference frame", valueType=float, orientation="horizontal")
            ShadowGui.lineEdit(self.sou_mov_box_1, self, "sm_offset_y_source_ref_frame", "offset Y [cm] in SOURCE reference frame", valueType=float, orientation="horizontal")
            ShadowGui.lineEdit(self.sou_mov_box_1, self, "sm_offset_z_source_ref_frame", "offset Z [cm] in SOURCE reference frame", valueType=float, orientation="horizontal")
